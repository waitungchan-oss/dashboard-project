...
請重新設計 UI/UX，但不要改變現有運行架構。正式儀表板仍由 `index.html`、`app.js`、`data/202604.json`、`data/202605.json` 組成，`app.js` 負責 fetch JSON、月份切換、Chart.js 圖表、drill-down、篩選器、formatter 與互動邏輯。
