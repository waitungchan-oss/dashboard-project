...
Also preserve the production PDF/print hooks:
...
PDF page assembly is already handled by `PRINT_SECTION_MANIFEST` in production `app.js`. Design output should not replace or duplicate that runtime logic.
